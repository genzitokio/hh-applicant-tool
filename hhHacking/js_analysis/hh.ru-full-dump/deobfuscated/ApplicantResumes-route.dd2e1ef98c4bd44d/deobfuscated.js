try {
  (function () {
    ...
    if (t) {
      ...
      e._sentryDebugIdIdentifier = "sentry-dbid-d8c2bf7f-824c-4bdd-8fbc-e31b32870026";
    }
  })();
} catch (e) {}
(function () {
...
(globalThis.__xhh_LOADABLE_LOADED_CHUNKS__ = globalThis.__xhh_LOADABLE_LOADED_CHUNKS__ || []).push([["8811"], {
  173544: function (e, t, s) {
    ...
    o.displayName = "layouts/BlokoLayouts/MagritteSideBarLayout/MagritteSideBarLayout";
  },
  350364: function (e, t, s) {
    ...
    l.displayName = "components/ApplicantObtainEpguCert/index/ApplicantObtainEpguCertBanner";
    const o = l;
  },
  139954: function (e, t, s) {
        ...
        return (0, r.jsx)("div", {
          ...
          children: (e => {
            ...
            if (e === "COUNTRY_BLACKLISTED" && a) {
              var r;
              const e = (r = Object.values(a)) === null || r === undefined ? undefined : r.map(e => s[d[e]]);
    ...
    u.displayName = "PhoneVerification/components/PhoneVerificationError/PhoneVerificationError";
    const m = (0, a.x)(u);
  },
  827080: function (e, t, s) {
    ...
    x.displayName = "PhoneVerification/components/SuccessNotification/SuccessNotification";
    const v = (0, m.x)(x);
    var y = s(859716);
    var f = s(36074);
    var b = s(372331);
      ...
      return {
        otpGenerate: async () => {
          ...
          try {
            ...
            var c;
            const s = e == null || (c = e.response) === null || c === undefined || (c = c.data) === null || c === undefined ? undefined : c.key;
            if (s) {
              t(s);
            } else {
              (0, r.eG)(e, v);
          ...
          h(false);
          x.updateCaptcha(o);
          if (((n = o.recaptcha) === null || n === undefined || !n.isBot) && ((i = o.hhcaptcha) === null || i === undefined || !i.isBot)) {
            if ((l = o.otp.phoneFormatted) !== null && l !== undefined && l.formatted) {
              if (s != null) {
    ...
    const F = ({
      ...
      const m = (() => {
        ...
        return async (t, s, n) => {
          ...
          a.append("code", t);
          a.append("phone", s);
          a.append("verificationSource", n ? "applicant_resumes" : "verification_page");
      ...
      return {
        setVerifiedPhone: async () => {
          ...
          var c;
          var h;
          if (!(p.updateCaptcha(l), x(false), l.recaptcha && (u(B(l.recaptcha)), l.recaptcha.isBot))) {
            if ((n = i) !== null && n !== undefined && (n = n.data) !== null && n !== undefined && (n = n.verification) !== null && n !== undefined && n.success) {
              E()({
                hhtmSource: d,
                errors: null
              });
              ...
              E()({
                hhtmSource: d,
                errors: l == null || (c = l.verification) === null || c === undefined ? undefined : c.key
              });
              o((h = i) === null || h === undefined ? undefined : h.data.verification);
            }
          }
        },
    ...
    const ie = ({
      ...
      const de = M ? a[B ? ae : se].replace("{0}", `${`0${Math.floor(M / 60)}`.slice(-2)}:${("0" + M % 60).slice(-2)}`) : a[B ? ne : te];
      const ue = c ? (0, p.jsx)(j.z, {
        ...
        children: (0, p.jsxs)(S.Z, {
          ...
          children: [(0, p.jsx)(g.r, {
            ...
            children: [(0, p.jsxs)("div", {
              className: z,
              children: [ce, (0, p.jsx)(O.Z, {
                className: "resume-recaptcha"
              }), (0, p.jsx)(q.Z, {}), (0, p.jsx)(k.X, {
                default: 24
              }), ue]
            }), me]
          })]
    ...
    const we = ({
      ...
      const m = [Se.Z.applicantResumes, Se.Z.applicantPhoneVerification].some(e => (0, ge.matchPath)(l, {
        path: e,
        exact: true,
        strict: true
      })) ? {
    ...
    const Pe = ({
      ...
      const I = async s => {
        try {
          ...
          await (({
            ...
            const a = JSON.stringify(e.filter(e => {
            ...
            return c._i.postFormData("/shards/phone/set_verified_phone_to_resumes", {
              allResumePhones: a,
              source: n
            });
          })({
      ...
      const M = ({
        ...
        L(s ?? 0);
        A(n);
        if (t != null && t.formatted && (t == null ? undefined : t.formatted) === y) {
    ...
    Pe.displayName = "ApplicantResumes/PhoneVerification/index/PhoneVerification";
    const Ie = Pe;
  },
  331913: function (e, t, s) {
    ...
    const g = ({
      ...
      return (0, j.jsx)(m.Z, {
        ...
        children: (0, j.jsxs)("div", {
          ...
          children: [(0, j.jsxs)(p.b, {
            children: [(0, j.jsx)(h.j, {
              type: "title",
              children: e
            }), (0, j.jsx)(h.j, {
              type: "subtitle",
    ...
    g.displayName = "components/ApplicantServiceSlider/ApplicantServiceCard/ApplicantServiceCard";
  },
  ...
  65110: function (e, t, s) {
    ...
    const p = {
      ...
      textSuspended: "applicantServicesSlider.cards.hasHhPro.statusSuspended.text"
    };
    ...
    const v = e => {
      ...
      const y = (0, n.useMemo)(() => {
        if (t) {
          const s = t.status === c.NB.Suspended ? e[p.textSuspended] : e[p.text];
          return (0, r.WU)(s, {
      ...
      const f = (0, n.useMemo)(() => t ? u.F6 : v ? `${u.Pp}?${a.j.stringify({
        tariffSet: "netology"
      })}` : u.Pp, [t, v]);
      const b = (0, n.useMemo)(() => s === c.Jd.Active ? e[p.title] : s === c.Jd.Frozen ? e[h] : e[m.title], [s, e]);
      return (0, n.useMemo)(() => ({
        id: "hh_pro",
        title: b,
        text: y,
  ...
  32470: function (e, t, s) {
        ...
        return (0, f.jsxs)(f.Fragment, {
          children: [S && (0, f.jsxs)(f.Fragment, {
            children: [(0, f.jsx)(i.Z, {
              ...
              borderWidth: "default",
              stretched: true,
              children: j.map((e, t) => (0, f.jsxs)(f.Fragment, {
                children: [t !== 0 && (0, f.jsx)(r.i, {}), (0, f.jsx)(u.N, {
                  title: e.title,
                  text: e.text,
                  icon: e.icon,
                  link: e.link,
            ...
            children: [o && o.map(e => (0, f.jsx)(p.F, {
              ...e
            }, e.id)), !b && x && (0, f.jsx)(d.Z, {}), (0, f.jsx)(h.a, {
    ...
    b.displayName = "components/ApplicantSideBar/index/ApplicantSideBarComponent";
    const j = (0, x.x)(b);
  },
  113367: function (e, t, s) {
    ...
    m.displayName = "components/ApplicantSkillsVerificationError/index/ApplicantSkillsVerificationErrorComponent";
    const p = (0, l.x)(m);
  },
  963750: function (e, t, s) {
    ...
    class c extends n.Component {
      ...
      componentWillUnmount() {
        ...
        var t;
        var s;
        if ((e = this.abortController) !== null && e !== undefined && (t = e.abort) !== null && t !== undefined) {
          t.call(e);
        }
        if (this.element) {
    ...
    const y = ({
      ...
      const f = (() => {
        const e = (0, m.v)(e => {
          var s;
          return ((s = e.searchClusters) === null || s === undefined || (s = s[p.Kz.Area]) === null || s === undefined || (s = s.selectedValues) === null || s === undefined ? undefined : s.map(String)) ?? null;
        }, r.shallowEqual);
        const t = (0, m.v)(e => [...new Set(e.vacancySearchResult.vacancies.flatMap(e => e.professionalRoleIds.flatMap(e => e.professionalRoleId)))], r.shallowEqual);
        return {
          ...(e && {
    ...
    y.displayName = "components/Banner/AdsExternalBanner/AdsExternalBannerComponent";
  ...
  799073: function (e, t, s) {
    ...
    const m = ({
      ...
      className: n,
      isBloko: i = false
    }) => e && e.length !== 0 ? i ? (0, d.jsxs)(u, {
      className: n,
      children: [t, (0, d.jsx)(l.Z, {
        groupClassNames: s,
        banners: e,
        children: (e, t) => (0, d.jsx)(r(), {
          xs: 4,
          s: 4,
          m: 4,
          l: 5,
  ...
  840933: function (e, t, s) {
    ...
    const o = ({
      groupClassNames: e,
      banners: t,
      children: s = (e, t) => (0, l.jsx)(n.Fragment, {
        children: e
      }, t)
    }) => (0, l.jsx)("div", {
      className: i()("banner-group-default", e),
      children: t.map((e, t) => s((0, l.jsx)(r.F, {
        ...e
      }, e.cId), e.cId, t))
    });
    ...
    const d = ({
      ...
      children: [t && (0, l.jsx)(c.s, {}), (0, l.jsx)(o, {
        banners: e,
        groupClassNames: a,
        children: s
      })]
    ...
    const p = ({
      ...
      (0, n.useEffect)(() => {
        ...
        const n = () => {
          var e;
          clearTimeout(s);
          if ((e = window.grecaptcha) !== null && e !== undefined && e.render) {
            ((e, t, s, n) => {
      ...
      return (0, u.jsxs)(u.Fragment, {
        ...
        }), s && (0, u.jsx)(i.FormSeparator, {}), (0, u.jsx)(i.FormError, {
          show: s,
  ...
  965073: function (e, t, s) {
    ...
    var n = s(503190);
    var a = s(4476);
    const i = (e, t, s) => a.default.init({
      element: e,
      onVisible() {
        window.requestIdleCallback(() => {
          n.default.waitingForBatchUrlReady().then(() => {
            var a;
            if (s != null && (a = s.abortSignal) !== null && a !== undefined && a.aborted) {
              return;
            }
            const {
              ids: i,
  ...
  114543: function (e, t, s) {
    ...
    const d = (e, t, s = false) => {
      ...
      const u = (n = o.params) !== null && n !== undefined && n.regions && o.params.regions[0].split(",").join(":") || "";
      const m = t.bannerCommonTargeting.puid1 ? `${u}:${t.bannerCommonTargeting.puid1}` : u;
      ...
      if (h) {
        ...
        if ((y = window.Ya) !== null && y !== undefined && (y = y._adListeners) !== null && y !== undefined && (y = y.hbCallbacks) !== null && y !== undefined) {
          y.push(() => {
            const e = Object.entries(c).reduce((e, [t, s]) => t in e ? e : Object.assign(e, {
              [t]: s(o.params[t])
            }), t.fastTargeting);
            return [{
              code: t.cId,
  ...
  503190: function (e, t, s) {
    ...
    const y = {
      ...
      put({
        ...
        if (Array.isArray(e)) {
          e.forEach(e => {
            t.forEach(t => {
              if (t.classList.contains(`HHC-Banner-${e.place}`) !== false && t.dataset.loaded !== "true") {
                if (e.empty) {
                  x(t, "emptyClass");
                  ...
                  e.advMarkTrls = t == null || (n = t.dataset) === null || n === undefined ? undefined : n.bannerAdvMarkTrl;
                  const a = {
                    detail: {
                      startTime: s,
                      bannerPlace: e.place,
      ...
      create(e, t, s, n = {}) {
        if (s) {
          ...
          if (r.length > 0) {
            r.forEach(e => {
              e.insertAdjacentHTML("beforeend", a.replace(/%id%/g, e.dataset.bannerId).trim());
              o.push(e.querySelector(`.${l}`));
            });
          } else {
            e.insertAdjacentHTML("beforeend", t.map(e => a.replace(/%id%/g, e).trim()).join(""));
      ...
      waitingForBatchUrlReady() {
        ...
        if ((e = window.globalVars) !== null && e !== undefined && e.bannersBatchUrl) {
          ...
          const t = setInterval(() => {
            var a;
            e += 1;
            if ((a = window.globalVars) !== null && a !== undefined && a.bannersBatchUrl) {
              clearInterval(t);
              s();
            }
    ...
    function b(e, t = {}) {
      ...
      if (Object.keys(t).length > 0) {
        ...
        if (((a = window.Ya) === null || a === undefined || !a.adfoxCode) && !y.requestedSystems.adfox) {
          y.requestedSystems.adfox = f("https://yandex.ru/ads/system/context.js");
        }
        if (!!t.headerBidding && !window.YaHeaderBiddingSettings && !y.requestedSystems.adfoxMock) {
          y.requestedSystems.adfoxMock = f("https://yandex.ru/ads/system/header-bidding.js");
        }
        Promise.all(Object.values(y.requestedSystems)).then(() => y.put({
          banners: [t]
        }, e, s)).catch(() => {});
      }
    }
  ...
  4476: function (e, t, s) {
    ...
    const n = {
      init(e) {
        ...
        const n = () => {
          if (!t) {
            if (s.offsetWidth || s.offsetHeight || s.getClientRects().length) {
              t = true;
              e.onVisible();
  ...
  844439: function (e, t, s) {
    ...
    H.displayName = "components/ApplicantNavigation/FindJobFasterButton/FindJobFasterButton";
    const q = (0, C.x)(H);
    var U = s(5808);
    var V = s.n(U);
    var O = s(880407);
    ...
    ne.displayName = "updateByBot/providers/UpdateCompactResumeByBotProvider/UpdateCompactResumeByBotProvider";
    var ae = s(842953);
    var ie = s(674070);
    var re = s(720278);
    var le = s(389371);
    ...
    const Fe = ({
      ...
      const a = (0, w.v)(e => e.applicantResumesAiAudit).find(e => e.resumeId === s);
      const i = a == null ? undefined : a.status;
      const r = (0, n.useRef)(null);
      const {
        fetchAICheckStatus: l
      } = (0, Pe.y)({
        resumeId: s
      });
      let o = e[Me];
      ...
      return (0, F.jsx)(Ae.j, {
        typography: "label-3-regular",
        right: t.AIStatus && t.AIStatus !== Ie.DN.Success ? undefined : (0, F.jsx)(ie.$dx, {
          initialColor: "positive"
        }),
    ...
    const We = ({
      ...
      const f = (0, c.usePush)();
      const b = (0, n.useMemo)(() => r.filter(e => e.status !== Ie.DN.Error), [r]);
    ...
    We.displayName = "CompactResumeCard/Links/AuditGenerate/AuditGenerateLink";
    const Je = (0, Ue.Z)(We);
    var Ke = s(442986);
    var Qe = s.n(Ke);
    const et = {
    ...
    nt.displayName = "CompactResumeCard/ResumeStatistecs/ResumeStatisticsItem/ResumeStatisticsItem";
    const at = (0, C.x)(nt);
    const it = ({
      disabled: e,
      padding: t = false,
    ...
    it.displayName = "CompactResumeCard/ResumeStatistecs/index/ResumeStatistics";
    var rt = s(941545);
    const lt = {
    ...
    ct.displayName = "CompactResumeCard/ResumeStatistecs/StatisticLink/StatisticsLink";
    const dt = (0, C.x)(ct);
    var ut = s(557558);
    ...
    const xt = ({
      ...
      if (S) {
        ...
        return (0, F.jsxs)(i.ElementShownAnchor, {
          fn: V(),
          status: j,
          position: d,
          resumeId: o,
          hhtmSource: "resume_list",
          children: [d !== 0 && (0, F.jsx)(we.i, {}), (0, F.jsx)($.Z, {
            ...
            children: (0, F.jsx)("div", {
              ...
              children: (0, F.jsxs)(Ne.b, {
                ...
                align: "top",
                children: [r && (0, F.jsxs)(F.Fragment, {
                  children: [(0, F.jsx)(Re.x, {
                    style: "secondary",
                    typography: "label-3-regular",
            ...
            className: ht,
            children: (f || b) && (0, F.jsxs)(F.Fragment, {
              children: [(0, F.jsx)(x.X, {
                default: 8
              }), (0, F.jsxs)(Ee.q, {
                default: 12,
                children: [u && (0, F.jsxs)(F.Fragment, {
                  children: [f, b]
                }), !u && (0, F.jsxs)(F.Fragment, {
                  children: [n && (0, F.jsx)(dt, {
                    resumeId: o,
                    resumeHash: h,
                    hhtmSource: m,
                    statistics: n
      ...
      return (0, F.jsxs)(i.ElementShownAnchor, {
        ...
        resumeId: o,
        hhtmSource: "resume_list",
        children: [d !== 0 && (0, F.jsx)(we.i, {}), (0, F.jsxs)("div", {
          className: mt,
          children: [(0, F.jsxs)(Ee.q, {
            default: 16,
            children: [u ? (0, F.jsxs)($.Z, {
              "data-qa": `resume-card-link-${h}`,
              stretched: true,
              children: [r && (0, F.jsxs)(F.Fragment, {
                children: [(0, F.jsx)(Re.x, {
    ...
    bt.displayName = "CompactResumes/CompactResumeCard/EmploymentFormsText/EmploymentFormsText";
    const jt = (0, C.x)(bt);
    var gt = s(652834);
    var St = s.n(gt);
    var kt = s(847461);
    ...
    qt.displayName = "CompactResumes/CompactResumeCard/WorkFormatsText/WorkFormatsText";
    const Ut = (0, C.x)(qt);
    ...
    const Xt = ({
      ...
      const o = (() => {
        ...
        return (a, c) => {
          const d = (0, W.ho)(a);
          const u = (e => (e == null ? undefined : e.professionalRole) || [])(a);
          ye.r.touch(d).then(() => {
      ...
      const x = (e => {
        var s;
        return (e == null || (s = e.salary) === null || s === undefined ? undefined : s[0]) ?? de;
      })(t);
      ...
      const b = (e => {
        var t;
        return (e == null || (t = e.title) === null || t === undefined || (t = t[0]) === null || t === undefined ? undefined : t.string) || "";
      })(t) || e[zt];
      const j = (0, W.No)(t);
      const {
      ...
      const {
        ...
        const r = (e => {
          var t;
          return (e == null || (t = e.accessType) === null || t === undefined || (t = t[0]) === null || t === undefined ? undefined : t.string) || "no_one";
        })(e);
      ...
      const {
        recommendationRef: A,
        sendRecommendationClickAnalytics: E
      } = (0, le.L)(u, S, g);
      ...
      if (C) {
        ...
        return (0, F.jsx)(xt, {
          ...
          secondaryActions: l ? (0, F.jsx)("div", {
            className: Vt,
            children: (0, F.jsx)(ae.r, {
              Element: c.SPALink,
              ref: A,
        ...
        if (S === ke.VQ.ChangeVisibility) {
          ...
          return (0, F.jsx)(xt, {
            ...
            subtitle: (0, F.jsxs)(F.Fragment, {
              children: [x != null && x.amount ? (0, F.jsx)(re.Z, {
                currency: x.currency,
                children: x.amount
              }) : e[Zt], " · ", (0, F.jsx)(Ut, {
                workFormats: v
    ...
    Xt.displayName = "CompactResumes/CompactResumeCard/index/CompactResumeCard";
    const Yt = (0, C.x)(Xt);
    var Wt = s(28537);
    var Jt = s(454386);
    var Kt = s(648695);
    ...
    function _s() {
      ...
      return (0, _.r)() && e && function (e) {
        return !!e.filter(({
          ...
          var t;
          return e != null && (t = e[0]) !== null && t !== undefined && !!t.string && Ss.includes(e[0].string);
        }).find(({
          _attributes: e
    ...
    const Vs = ({
      ...
      return (0, F.jsxs)("div", {
        ...
        children: [(0, F.jsx)(Z.D, {
          ...
          className: Ms,
          children: t ? (0, F.jsx)(ae.r, {
            iconLeft: (0, F.jsx)(ie.xAJ, {}),
            onClick: () => x(true),
            children: e[Bs]
          }) : (0, F.jsxs)(F.Fragment, {
            children: [u && i ? (0, F.jsx)(I.z, {
          ...
          children: [(0, F.jsx)(I.z, {
            ...
            mode: "tertiary",
            style: "neutral",
            "data-qa": a ? "resumeservice-button__createResumeZP" : "resumeservice-button__createResumeHH",
            icon: (0, F.jsx)(ie.GhD, {}),
            onClick: a ? b : f,
    ...
    Vs.displayName = "components/ApplicantNavigation/index/ApplicantNavigation";
    const Os = (0, C.x)(Vs);
    var zs = s(895370);
    var Zs = s.n(zs);
    var $s = s(861044);
    ...
    sn.displayName = "components/CareerPlatformBanner/index/ProxyCareerPlatformBanner";
            ...
            children: [(0, F.jsx)(x.X, {
              ...
              children: l.map((e, t) => {
                ...
                return (0, F.jsxs)(i.ElementShownAnchor, {
                  ...
                  resumeId: a,
                  hhtmSource: "resume_list",
                  children: [(0, F.jsx)(fs.N, {
                    resume: e,
                    position: t
                  }), s && t === 0 && (0, F.jsxs)(F.Fragment, {
                    children: [(0, F.jsx)(x.X, {
                      default: 16,
                      gteS: 16
                    }), r ? (0, F.jsx)(tn, {}) : (0, F.jsx)(un, {})]
    ...
    const Ln = ({
      ...
      const u = () => (0, F.jsx)($.Z, {
        ...
        children: (0, F.jsxs)("div", {
          className: An,
          children: [(0, F.jsx)(Ne.b, {
            right: (0, F.jsx)(ie.eTh, {}),
            left: s
          }), (0, F.jsx)(x.X, {
            default: 16
          }), (0, F.jsxs)(Ne.b, {
            children: [(0, F.jsx)(Ae.j, {
              type: "title",
              children: e
            }), (0, F.jsx)(Ae.j, {
              type: "subtitle",
    ...
    Ln.displayName = "components/ApplicantServicesSlider/ApplicantServicesCard/ApplicantServicesCard";
    ...
    qn.displayName = "components/ApplicantServicesSlider/index/ApplicantServicesSlider";
    const Un = (0, C.x)(qn);
    var Vn = s(331913);
    var On = s(815853);
    ...
    Zn.displayName = "components/ApplicantServicesSliderRedesign/index/ApplicantServicesSliderRedesign";
    const $n = (0, C.x)(Zn);
    var Gn = s(885309);
    var Xn = s.n(Gn);
    var Yn = s(784927);
    ...
    la.displayName = "components/ApplicantSkillsVerificationIcon/index/ApplicantSkillsVerificationIcon";
    const oa = la;
    var ca = s(963252);
    var da = s(26149);
    var ua = s.n(da);
    ...
    const ga = ({
      ...
      const {
        ...
        const u = !!e && d != null && !!d.keySkills && !!(d.keySkills.length < 30) && !d.keySkills.find(t => t.string === e);
        const m = (0, n.useMemo)(() => ({
          skillId: t,
          level: s,
          resumeHash: d.hash
        ...
        const p = (0, n.useCallback)(() => {
          ...
          if (!d) {
            throw new Error("auto-add skill to resume: not enough data to add skill to resume");
          }
          const s = new FormData();
          s.append("key_skills", JSON.stringify([...d.keySkills, {
            string: e
          }]));
          ...
          va.default.log("out", "auto-add skill to resume: sendBeacon is not available");
          return ya._i.post(t, s, {
            params: {
              resume: d.hash
            }
          }).then(() => o(true));
    ...
    const oi = ({
      ...
      var b;
      var j;
      const g = (t == null || (i = t.items) === null || i === undefined || (i = i[0]) === null || i === undefined ? undefined : i.name) || "";
      const S = (t == null || (r = t.items) === null || r === undefined || (r = r[0]) === null || r === undefined || (r = r.level) === null || r === undefined ? undefined : r.rank) || 2;
      const k = (t == null || (l = t.items) === null || l === undefined || (l = l[0]) === null || l === undefined ? undefined : l.result.status) === "SUCCESS" || false;
      const C = Boolean((t == null || (o = t.items) === null || o === undefined || (o = o[0]) === null || o === undefined ? undefined : o[P.l9.CourseUrl]) && t.method[P.l9.BrandingSettings][P.l9.CtaButtonEnabled]);
      const _ = t == null || (d = t.items) === null || d === undefined || (d = d[0]) === null || d === undefined ? undefined : d[P.l9.CourseUrl];
      const N = t == null || (u = t.items) === null || u === undefined || (u = u[0]) === null || u === undefined || (u = u.result) === null || u === undefined || (u = u.score) === null || u === undefined ? undefined : u.actual;
      const R = t == null || (m = t.items) === null || m === undefined || (m = m[0]) === null || m === undefined || (m = m.result) === null || m === undefined || (m = m.score) === null || m === undefined ? undefined : m.max;
      const A = (t == null || (h = t.items) === null || h === undefined || (h = h[0]) === null || h === undefined ? undefined : h.category) === "SKILL";
      const E = (0, ca.n)(ai);
      const {
        isMobile: L
      } = (0, p.G)();
      ...
      const B = (x = t.items) === null || x === undefined || (x = x[0]) === null || x === undefined ? undefined : x.name;
      const D = (v = t.items) === null || v === undefined || (v = v[0]) === null || v === undefined ? undefined : v.id;
      const H = (y = t.items) === null || y === undefined || (y = y[0]) === null || y === undefined ? undefined : y[P.l9.PracticeStatus];
      const q = ((f = t.items) === null || f === undefined || (f = f[0]) === null || f === undefined || (f = f.result) === null || f === undefined ? undefined : f[P.l9.AntifraudVerdict]) || P.Kb.Unknown;
      ...
      const W = () => {
        if (s) {
          ea()({
            ...z,
            isDetail: !!s.theory.successfulTopics.length || !!s.theory.topicsToImprove.length
          });
          window.open(`/applicant/skills/${s.id}/${s.level.id}/report?category=${s.category}`, "_blank");
        }
      };
      const J = S <= 3 ? e[ni[S]] : "";
      const K = s => {
        ...
        let a = e[za];
        let i;
        if ((ii(s) || ["SUCCESS", "FAILURE"].includes(s)) && t.method.platform === "KAK_DELA_QUIZ") {
          n = e[Ga];
          a = e[Xa];
        }
        ...
        if (k) {
          if (C) {
            return (0, F.jsx)(Re.x, {
              style: "secondary",
              "data-qa": "test-result-text",
              children: (s = t.items) === null || s === undefined || (s = s[0]) === null || s === undefined ? undefined : s.content
            });
          } else if (V) {
            if (L) {
              return (0, F.jsxs)("div", {
                children: [(0, F.jsxs)(Re.x, {
                  style: "secondary",
                  "data-qa": "test-result-text",
                  children: [e[ti], "."]
                }), (0, F.jsx)(Re.x, {
          ...
          return li(C ? (n = t.items) === null || n === undefined || (n = n[0]) === null || n === undefined ? undefined : n.content : V ? e[Ka] : "", e[Qa]);
        }
      };
      const ee = () => !k && (0, F.jsxs)("div", {
        className: Ta,
        children: [(0, F.jsx)(ie.ARe, {}), (0, F.jsx)(Re.x, {
          style: "primary",
          typography: "label-3-regular",
        ...
        children: [A && k && D && B && S && (0, F.jsx)(Sa, {
          ...
          children: (0, F.jsxs)("div", {
            ...
            children: [(() => {
              ...
              background: true,
              success: k,
              name: ((b = t.items) === null || b === undefined || (b = b[0]) === null || b === undefined ? undefined : b.category) === "LANG" ? t.method.name : g
            }), (0, F.jsx)("div", {
              className: Ma,
              children: ee()
            }), Q()]
          ...
          options: (0, F.jsxs)("div", {
            ...
            children: [(0, F.jsxs)("div", {
              ...
              children: [(0, F.jsx)(Aa, {
                ...
                background: true,
                success: k,
                name: ((j = t.items) === null || j === undefined || (j = j[0]) === null || j === undefined ? undefined : j.category) === "LANG" ? t.method.name : g
              }), ee()]
            }), Q()]
          }),
          footer: (0, F.jsx)(ss.o, {
    ...
    const ki = ({
      ...
      const u = () => r().sendHHEventButtonClick("vacancy-response-counter-suitable");
      const m = (0, n.useMemo)(() => (0, di.v)(i, {
        one: t[gi.title.one],
        some: t[gi.title.some],
        many: t[gi.title.one]
      }).replace("{0}", String(i)), [t, i]);
      const v = (0, n.useMemo)(() => (0, di.v)(o, {
        one: t[ji.title.one],
        some: t[ji.title.some],
        many: t[ji.title.one]
      }).replace("{0}", String(o)), [t, o]);
      return (0, F.jsxs)($.Z, {
        stretched: true,
        padding: s ? 12 : 24,
        borderWidth: "default",
        ...
        children: [(0, F.jsxs)("div", {
          className: yi,
          children: [s ? undefined : (0, F.jsxs)(F.Fragment, {
            children: [l, (0, F.jsx)(ui.V, {
              default: 12
            })]
          }), (0, F.jsx)("div", {
            className: fi,
            children: (0, F.jsxs)(h.z, {
              ...
              children: [(0, F.jsx)(Re.x, {
                ...
                style: "secondary",
                children: o > 0 ? t[ji.hint].replace("{0}", String(a)) : t[gi.hint]
              })]
            })
          }), (0, F.jsx)(ui.V, {
            default: 12
    ...
    ki.displayName = "components/VacancyResponseCounter/index/VacancyResponseCounter";
    const Ci = (0, C.x)(ki);
    var _i = s(336692);
    ...
    Ri.displayName = "components/Notifications/ApplicantResumes/ResumeSaveError";
    const Ai = {
      Element: (0, C.x)(Ri),
    ...
    Ei.displayName = "components/Notifications/ApplicantResumes/ResumeSaveSuccess";
    const Li = {
      Element: (0, C.x)(Ei),
    ...
    Mi.displayName = "ApplicantResumes/components/ApplicantResumesPage/FullRowBlock";
    const Ti = ({
      trls: e
    }) => {
      const t = (0, c.usePush)();
      ...
      const l = (0, w.v)(e => {
        var t;
        return (e == null || (t = e.applicantProfile) === null || t === undefined ? undefined : t.status) === "BLOCKED";
      });
      const u = (0, _.r)();
      const m = (0, w.v)(A.F);
      const C = (0, w.v)(E.DJ);
      ...
      (() => {
        ...
        (0, n.useEffect)(() => {
          ...
          if (a && a != null && a.length && a[0] === "university_mapping_saved") {
            t(Li);
          }
          return () => {
            s(Ai);
        ...
        children: (0, F.jsx)(y.Xg, {
          ...
          children: (0, F.jsxs)(h.z, {
            ...
            children: [(0, F.jsx)(Mi, {
              ...
              children: [!V && !O && (0, F.jsx)(Un, {}), (V || O && r) && (0, F.jsx)($n, {})]
            }), (0, F.jsx)(Mi, {
              children: (0, F.jsx)(hn, {})
            }), u && I && (0, F.jsx)(Mi, {
              children: (0, F.jsx)(S.X, {
    ...
    Ti.displayName = "ApplicantResumes/components/ApplicantResumesPage/ApplicantResumesPage";
    const Bi = (0, C.x)(Ti);
    const Fi = () => (0, F.jsx)(Bi, {});
    Fi.displayName = "pages/ApplicantResumes/ApplicantResumes.route/ApplicantResumesRoute";
    const Di = Fi;
  }
