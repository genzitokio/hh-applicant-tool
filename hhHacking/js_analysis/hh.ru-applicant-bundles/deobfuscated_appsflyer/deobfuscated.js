...
function _iterableToArrayLimit(e, r) {
  ...
  if (t != null) {
    ...
    try {
      o = (t = t.call(e)).next;
      if (r !== 0) {
        for (; !(l = (a = o.call(t)).done) && (s.push(a.value), s.length !== r); l = true);
      }
    } catch (e) {
      c = true;
      n = e;
...
function _unsupportedIterableToArray(e, r) {
  ...
  if (e) {
    ...
    } else if ((t = (t = {}.toString.call(e).slice(8, -1)) === "Object" && e.constructor ? e.constructor.name : t) === "Map" || t === "Set") {
      return Array.from(e);
...
function getParameterValue(e) {
  ...
  if (n != null && n.keys && Array.isArray(n.keys) || n != null && n.defaultValue) {
    t = n.keys;
    a = (a = n.overrideValues) === undefined ? {} : a;
    r = (r = n.defaultValue) === undefined ? "" : r;
    return (t = (t === undefined ? [] : t).find(function (r) {
      return !!e[r];
    })) && (a[a = e[t]] || a) || r;
  } else {
...
function getQueryParamsAndSaveToLocalStorage(e) {
  ...
  try {
    ...
    var a = Array.from(t).reduce(function (e, r) {
      ...
      r = r[1];
      return _objectSpread2(_objectSpread2({}, e), {}, _defineProperty({}, t, encodeURIComponent(r)));
    }, {});
    var n = JSON.parse(localStorage.getItem("ss_incoming_params") || "[]");
    var o = new Date().getTime() + 7200000;
    var i = _objectSpread2(_objectSpread2({}, a), {}, {
      af_ss_exp_at: o
    });
    n.unshift(i);
...
function removeExpiredLocalStorageItems(e = Date.now()) {
  ...
  localStorage.setItem("ss_incoming_params", JSON.stringify(r.filter(function (r) {
    r = r.af_ss_exp_at;
    return e < r;
  })));
}
function aggregateValuesFromParameters(e = {}) {
  ...
  if (e.hasOwnProperty("googleClickIdKey") && typeof e.googleClickIdKey == "string") {
...
function getCurrentURLParams(e) {
  ...
  if (Object.keys(localStorage).includes("ss_incoming_params")) {
    r = JSON.parse(localStorage.ss_incoming_params).find(function (r) {
...
function isOneLinkURLValid(e) {
  ...
  return !!r && !((r == null ? undefined : r.length) < VALID_AF_URL_PARTS_LENGTH) || (console.error("oneLinkURL is missing or not in the correct format, can't generate URL", e), false);
}
function isMSValid(e = {}) {
  return e != null && !!e.defaultValue || (console.error("mediaSource is missing (default value was not supplied), can't generate URL", e), false);
}
    ...
    r.forEach(function (e) {
      ...
      if (e != null && e.paramKey) {
        ...
        if ((e == null ? undefined : e.paramKey) === n || r) {
          console.debug("Custom parameter ParamKey can't override Google-Click-Id or AF Parameters keys", e);
        } else {
...
function validateAndMappedParams(_param, e = {}, r = false) {
  var t = (y = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {}).mediaSource;
  var a = y.campaign;
  var n = y.channel;
  var o = y.ad;
  var i = y.adSet;
  ...
  if (t) {
    if (!(y = getParameterValue(e, t))) {
      console.error("mediaSource was not found in the URL and default value was not supplied, can't generate URL", t);
      return null;
    }
  ...
  if (a) {
    if (!(t = getParameterValue(e, a)) && r) {
      console.error("campaign was not found in the URL and default value was not supplied, can't generate URL", a);
      return null;
    }
    if (r) {
      g.af_campaign = t;
  ...
  if (p) {
    if (GCLID_EXCLUDE_PARAMS_KEYS.find(function (e) {
      return e === p;
    })) {
...
function isPlatformValid(e) {
  if (e) {
    return !!["smartcast", "tizen", "roku", "webos", "vidaa", "playstation", "android", "ios", "steam", "quest", "battlenet", "epic", "switch", "xbox", "nativepc"].includes(e.toLowerCase()) || (console.error("platform need to be part of the known platforms supoorted"), false);
  } else {
...
function getUserAgentData() {
  return new Promise(function (e) {
    if (isUACHSupported()) {
      navigator.userAgentData.getHighEntropyValues(["model", "platformVersion"]).then(function (r) {
        e({
          model: r.model,
    ...
    return new Promise(function (r) {
      getUserAgentData().then(function (t) {
        ...
        if (t) {
          ...
          a.searchParams.append("af_ch_os_version", encodeURIComponent(t.platformVersion));
        }
        r(a.href);
      }).catch(function () {
        r();
...
function processTrackingParameters(e) {
  e = updateFinalUrlWithForwardParameters(e, [GOOGLE_CLICK_ID, FACEBOOK_CLICK_ID, GBRAID, WBRAID], window.location.search);
  ...
  if ((r || t || a) && (r = getParameterValueFromURL(window.location.search, ASSOCIATED_AD_KEYWORD), t = getParameterValueFromURL(e, AF_KEYWORDS), r) && !t) {
...
window.AF_SMART_SCRIPT = {
  generateOneLinkURL: function () {
    ...
    var i = r.webReferrer;
    if (isOneLinkURLValid(t) && isSkipListsValid({
      referrerSkipList: n,
      urlSkipList: o
    }) && isMSValid(a) && (n = getCurrentURLParams(aggregateValuesFromParameters(r.afParameters)), o = validateAndMappedParams(r.afParameters, n))) {
      a = _objectSpread2({
        af_js_web: true,
        af_ss_ver: window.AF_SMART_SCRIPT.version
      }, o);
      e = t + stringifyParameters(a).replace("&", "?");
      r = JSON.parse(localStorage.getItem(LOCAL_STORAGE_VALUES.SS_WEB_REFERRER));
      if (i && r && isValidUrl(r)) {
        n = `&${i}=${r}`;
        e = `${e}${n}`;
      }
          ...
          if (s) {
            ...
            if (isPlatformValid(o)) {
              if (typeof i != "string") {
                ...
                return null;
              } else if ((t == null || (e = t.keys) == null ? undefined : e.length) !== 0 || t != null && t.defaultValue) {
                if (isSkipListsValid({
                  referrerSkipList: a,
                  urlSkipList: n
                }) && isMSValid(l) && (e = getCurrentURLParams(aggregateValuesFromParameters(r.afParameters)), a = validateAndMappedParams(r.afParameters, e, true))) {
                  n = _objectSpread2({
                    af_js_web: true,
                    af_ss_ver: window.AF_SMART_SCRIPT.version
                  }, a);
                  ...
                  if (["ios", "android"].includes(o)) {
                    a = a.replace("af_media_source", "pid").replace("af_campaign", "c").replace("af_campaign_id", "af_c_id");
                  }
                ...
                console.error("campaign is missing (default value was not supplied), can't generate URL", l);
                return null;
              }
            } else {
              return null;
