  ...
  try {
    ...
    if (TargetAdsQueues.length === 0) {
      ...
      localStorage.setItem(
        `_tads${this.projectId}_queue`,
        JSON.stringify(TargetAdsQueues),
      );
    }
    if (n.status === 200 || n.status === 204) {
      ...
      this.log(
        `Data wasn't send.Status code is ${n.status}.Response text ${n.body}`,
        true,
      );
    }
  } catch (s) {
  ...
  if (t && typeof t == "object") {
    try {
      ...
      if (e) {
        Object.keys(t)
          .slice(0, e)
          .map((e) => (r[e] = this.convertToString(t[e])));
      } else {
  ...
  if (t === "purchase") {
    ...
    for (const t of e.items) {
      if (t.hasOwnProperty("id") || t.hasOwnProperty("title")) {
        if (
          this.convertToString(t.id) !== "" ||
          this.convertToString(t.title) !== ""
        ) {
          r.ecommerce_items.id.push(
            this.getValueOrDefault(t, "id", "", "string"),
          );
          r.ecommerce_items.title.push(
            this.getValueOrDefault(t, "title", "", "string"),
          );
          r.ecommerce_items.category1.push(
            this.getValueOrDefault(t, "category1", "", "string"),
          );
          r.ecommerce_items.category2.push(
            this.getValueOrDefault(t, "category2", "", "string"),
          );
          r.ecommerce_items.brand.push(
            this.getValueOrDefault(t, "brand", "", "string"),
          );
          r.ecommerce_items.variant.push(
            this.getValueOrDefault(t, "variant", "", "string"),
          );
          r.ecommerce_items.quantity.push(
            this.getValueOrDefault(t, "quantity", 0, "number"),
          );
          r.ecommerce_items.price.push(
            this.getValueOrDefault(t, "price", 0, "number"),
          );
        } else {
    ...
    if (
      r.ecommerce_items.id.length === 0 ||
      r.ecommerce_items.title.length === 0
    ) {
    ...
    if (
      this.convertToString(e.id) === "" &&
      this.convertToString(e.title) === ""
    ) {
...
TargetAds.prototype.event = function (t, e = {}) {
  ...
  if (t === "page_view") {
    if (
      ...
      if (
        T.event_params &&
        typeof T.event_params == "object" &&
        !Array.isArray(T.event_params)
      ) {
        ...
        r.cp = this.convertToObjectString(
          Object.assign(r.cp || {}, T.event_params),
          5,
        );
    ...
    if (c(l) && h) {
      ...
      if (Object.keys(O).length && this.isCheckUtm) {
        ...
        if (D.includes(g)) {
          ...
          this.startSession = 1;
          const C = i(
            `${this.projectId}_${this.getCid()}_${this.getUserAgent()}_${new Date().getTime()}`,
          );
  ...
  if (t === "event" && e && Object.entries(e).length > 0 && !Array.isArray(e)) {
    ...
    if (x.user && typeof x.user == "object" && !Array.isArray(x.user)) {
      ...
      this.log(
        "TargetAds: user object and his uid argument not found (an optional parameter)",
        true,
      );
    }
    ...
    if (
      x.event_params &&
      typeof x.event_params == "object" &&
      !Array.isArray(x.event_params)
    ) {
      ...
      r.cp = this.convertToObjectString(
        Object.assign(r.cp || {}, x.event_params),
        5,
      );
    }
    if (r.cp && r.cp.hasOwnProperty("uid")) {
    ...
    if (
      J.event_params &&
      typeof J.event_params == "object" &&
      !Array.isArray(J.event_params)
    ) {
      ...
      r.cp = this.convertToObjectString(
        Object.assign(r.cp || {}, J.event_params),
        5,
      );
    ...
    }
    {
      ...
      if (
        M.event_params &&
        typeof M.event_params == "object" &&
        !Array.isArray(M.event_params)
      ) {
        ...
        r.cp = this.convertToObjectString(
          Object.assign(r.cp || {}, M.event_params),
          5,
        );
    ...
    if (t.length > 0) {
      if (t[0] === "init") {
        if (t.length > 1 && isNaN(t[1])) {
          ...
          localStorage.setItem(
            "_tads_init",
            JSON.stringify([...t].slice(1).map((t) => t)),
          );
          return;
        }
      }
