try {
  (function () {
    ...
    if (a) {
      ...
      e._sentryDebugIds[a] = "b66fad82-7e25-4cd8-93ce-3a89991641d6";
      e._sentryDebugIdIdentifier =
        "sentry-dbid-b66fad82-7e25-4cd8-93ce-3a89991641d6";
    }
  })();
} catch (e) {}
(function () {
...
(globalThis.__xhh_LOADABLE_LOADED_CHUNKS__ =
  ...
  ["7877"],
  {
    226453: function (e, a, t) {
      t.d(a, {
        Z: () => i,
      });
      const i = {
        accountAddEmail: "/account/add_email",
        accountConnect: "/account/connect/(register|merge|phone-request)",
        ...
        applicantCountriesVisibility:
          "/applicant/settings/resume_countries_visibility",
        ...
        applicantMyResumes: "/applicant/my_resumes",
        applicantSkillVerificationsMethods:
          "/applicant/skill_verifications/methods",
        ...
        applyApplicantAgreement: "/account/apply_applicant_agreement",
        appPromo: "/app_promo",
        article: [
          "/article/:articleId([a-zA-Z0-9_-]+)",
          "/article.(do|xml)",
          "/interview/:articleId([a-zA-Z0-9_-]+)",
          "/account/login/two_factor_article",
        ],
        ...
        chat: "/chat",
        downloadReports: "/employer/statistics/downloadReports",
        ...
        employerAdvices: `/employer/advices/:adviceType(${t(515417).bt.join("|")})`,
        employerCart: "/employer/cart",
        employerCartPayment: "/employer/cart/payment",
        ...
        employerUnpremoderatedVacancyList:
          "/employer/unpremoderatedvacancylist",
        ...
        employerVacanciesPromotion:
          "/employer/vacancies/:vacancyId(\\d+)/promotion",
        EmployerVacanciesAuctionWebview:
          "/employer/vacancies/:vacancyId(\\d+)/auction",
        employerVacanciesRise: "/employer/vacancies/rise",
        employerVacanciesAuctionMultiCreation:
          "/employer/vacancies/auction-multi-creation",
        employerVacanciesVr: "/employer/vacancies/vr",
        employerView:
          "/employer/(edit|\\d+)(|/main|/mission|/career|/recruitment|/office|/address)",
        employerViolations: "/employer/violations",
        ...
        statportal: "/employer/statistics/index",
        ...
        resumeSearchCatalogListByLetter:
          "/resumes/:type(eng|rus|etc)/:char([a-z]{1,3})?/:page(page-\\d+)?",
        ...
        applicantSkillVerificationShortReport:
          "/applicant/verification_result/:token",
        applicantObtainEpguCertificates: "/applicant/obtain_epgu_certificates",
        applicantSkillVerificationReport:
          "/applicant/skills/:skill_id/:level_id/report",
        applicantContestResult: "/applicant/contest_result",
        applicantKeyskillsVerificationMethods:
          "/applicant/:type(skills|langs)/:id(\\w+)/verification_methods",
        ...
        salaryCalculator: "/kalkulyator-zarplat",
        settings: "/settings",
        subscribe: "/subscribe",
        support: "/support",
        ...
        vacancyConstructorMobilePreview:
          "/employer/vacancyconstructor/template/(\\d+)/mobile",
        vacancyConstructorTemplatePreview:
          "/employer/vacancyconstructor/template/:templateId(\\d+)",
        ...
        ApplicantAutosearchUnsubscribe: "/applicant/autosearch-unsubscribe",
        ...
        VacancyResponsesAutoSurvey: "/employer/vacancyresponses/autosurvey",
        VacancyResponsesFunnel: "/employer/vacancyresponses/funnel",
        vacancyResponsesCalls: "/employer/vacancyresponses/calls(.mvc)?",
        vacancyResponsesOutcomingCalls:
          "/employer/vacancyresponses/outcoming_calls(.mvc)?",
        vacancyResponsesActiveCandidates:
          "/employer/vacancyresponses/active-candidates",
        vacancyResponsesNeuroResponse:
          "/employer/vacancyresponses/neuroresponse",
        vacancyResponsesAiAssistant: "/employer/vacancyresponses/ai-assistant",
        vacancyResponsesAiAssistantQuestionsSettings:
          "/employer/vacancyresponses/ai-assistant/questions_settings",
        vacancyResponseTest: "/applicant/vacancy_response/test",
        vacancyResponsesNeuroResponseStatistics:
        ...
        webCallAppPromo: "/webcall-app-promo",
        callsHistory: "/calls-history",
        vacancySearchMetroCatalog: "/metro/:line/:station?",
        vacancySearchCatalogListMain: "/vacancies",
        vacancySearchCatalogListByLetter:
          "/vacancies/:type(eng|rus|etc)/:char([a-z]{1,3})?/:page(page-\\d+)?",
        vacancySearchCatalog:
          "/vacancies/:professionOrExtraFilter/:extraFilter?",
        ...
        vrsurvey: "/vrsurvey",
        services: "/services",
        zpEmployerMigrate: "/employer/zp_employer_migrate",
        ...
        employerHiringManagerArchivedVacancies:
          "/employer/hiring_manager/vacancies/archived",
        ...
        cloudPayments: "/employer/invoice/cloudpayments",
        employerVerification: "/employer/verification",
        employerCandidates: "/employer/candidates",
        skills: "/skills",
        careerPlatformFront: "/career_platform",
        assessment: "/assessment",
        externalCertificate: "/applicant/external_certificate/:resume_hash/:id",
        resumeView: "/applicant/resumes/view",
        resumeViewByID: "/resume/:id",
        resumeEditByID: "/resume/edit/:id/:blockName",
        resumeEditByIDWithIndex: "/resume/edit/:id/:blockName/:index(\\d+)",
        resumeEditBlockAbout: "/resume/edit/:id(\\w+)/about",
        resumePositionEditor: "/resume/edit/:id(\\w+)/position",
        resumeContactsEditor: "/resume/edit/:id(\\w+)/contacts",
        resumeKeySkillsEditor: "/resume/edit/:id(\\w+)/keySkills",
        resumeVisibilityEditor: "/resume/edit/:id(\\w+)/visibility",
        resumeCertificateEditor: [
          "/resume/edit/:id(\\w+)/certificate/:index(\\d+)",
          "/resume/edit/:id(\\w+)/certificate",
        ],
        resumeExperienceEditor: [
          "/resume/edit/:id(\\w+)/experience/:index(\\d+)",
          "/resume/edit/:id(\\w+)/experience",
        ],
        resumeSkillsLevelsEditor: [
          "/resume/edit/:id(\\w+)/skillsLevels",
          "/resume/edit/:id(\\w+)/skillsLevels/:index(\\d+)",
        ],
        resumeRecommendationEditor: [
          "/resume/edit/:id(\\w+)/recommendation",
          "/resume/edit/:id(\\w+)/recommendation/:index(\\d+)",
        ],
        resumeAdditionalEducationEditor: [
          "/resume/edit/:id(\\w+)/additionalEducation",
          "/resume/edit/:id(\\w+)/additionalEducation/:index(\\d+)",
        ],
        resumeAttestationEducationEditor: [
          "/resume/edit/:id(\\w+)/attestationEducation",
          "/resume/edit/:id(\\w+)/attestationEducation/:index(\\d+)",
        ],
        resumeEducationViewBlock: "/resume/:id(\\w+)/education",
        resumeExperienceViewBlock: "/resume/:id(\\w+)/experience",
        resumeCertificateViewBlock: "/resume/:id(\\w+)/certificate",
        resumeRecommendationViewBlock: "/resume/:id(\\w+)/recommendation",
        resumeAdditionalEducationViewBlock:
          "/resume/:id(\\w+)/additionalEducation",
        resumeAttestationEducationViewBlock:
          "/resume/:id(\\w+)/attestationEducation",
      };
    },
    195264: function (e, a, t) {
      t.r(a);
      t.d(a, {
        default: () => y,
      });
      ...
      var n = t(226453);
      var l = t(268155);
      const p = [n.Z.vacancySearch, n.Z.vacancySearchMap];
      var d = (function (e) {
        e.Style = "style";
        e.Image = "image";
        e.Opacity = "opacity";
      ...
      const y = c.default.build({
        ...
        create: (e, a) => {
          const n = o.L.get("uxs_uid") ?? "";
          const y = o.L.get("crypted_id") ?? "";
          const v = o.L.get("crypted_hhuid") ?? "";
          const h = (() => {
            const a = o.L.get("hhrole") ?? "";
            if (["employer", "anonymous", "applicant"].includes(a)) {
              return a;
            } else {
              return "";
            }
          })();
          const g = a.additionalParams;
          const f = document.createElement("iframe");
          f.src = a.iframeSrc;
          f.classList.add("uxfeedback-widget");
          f.setAttribute(
            "sandbox",
          ...
          const b = (e, a) => {
            var t;
            if ((t = f.contentWindow) !== null && t !== undefined) {
              t.postMessage(
                {
                  type: `uxfb/${e}`,
                  payload: a,
          ...
          const w = a.sendEventsOnLoad;
          let _ = false;
          const E = ({ eventName: e, attributes: a }) => {
            const t = {
              event: e,
              ...(a
                ? {
          ...
          window.addEventListener("message", (e) => {
            ...
            const [c, l] = (typeof t == "string" ? t : "").split("/");
            const A = l;
            if (e.origin === a.iframeOrigin && c === "uxfb") {
              if (A === d.Style && m(i)) {
                if (i.search(/display\s*?:\s*?none/i) > -1) {
                  r().sendHHEvent("button_click", {
                    buttonName: "ux_feedback_close",
                    cryptedId: y,
                    cryptedHhuid: v,
                  });
                } else if (i.search(/display\s*?:\s*?block/i) > -1) {
                  r().sendHHEvent("element_shown", {
                    elementName: "ux_feedback",
                    cryptedId: y,
                    cryptedHhuid: v,
                  });
                }
              ...
              if (
                ...
                ((e) =>
                  e !== null &&
                  typeof e == "object" &&
                  typeof (e == null ? undefined : e.name) == "string" &&
                  typeof (e == null ? undefined : e.value) == "string" &&
                  typeof (e == null ? undefined : e.maxAge) == "number")(i)
              ) {
                if (i.name === "uxs_uid") {
                  o.L.set(i.name, i.value || "", i.maxAge || 34560000);
                }
              } else {
                if (A === d.Opacity && ((e) => typeof e == "number")(i)) {
                  k = i;
                  f.style.opacity = `${k}`;
                  return;
                }
                    ...
                    (() => {
                      ...
                      b(d.Info, {
                        ...
                        cookies: [
                          !!n && `uxs_uid=${n}`,
                          `role=${h}`,
                          `showFirstExperienceSurvey=${g.showFirstExperienceSurvey}`,
                          `employerSurveyState=${g.employerState}`,
                        ]
                          .filter(Boolean)
                          .join("; "),
        ...
        componentName: "legacy/HH/Uxfeedback",
      });
    },
    515417: function (e, a, t) {
      t.d(a, {
        EB: () => o,
        M: () => r,
        bt: () => s,
      ...
      const i = 100;
      let r = (function (e) {
        e.McpManagersUnreadResponses = "MCP_MANAGERS_UNREAD_RESPONSES";
        e.ManagerUnreadResponses = "MANAGER_UNREAD_RESPONSES";
        e.MakeSalaryCloserToMarket = "MAKE_SALARY_CLOSER_TO_MARKET";
        return e;
      })({});
      let o = (function (e) {
        e.Tele2CallTrackingTip = "TELE2_CALL_TRACKING_TIP";
        e.VacanciesActiveAdviceDefault = "VACANCIES_ACTIVE_ADVICE_DEFAULT";
        e.VacanciesDraftsAdviceDefault = "VACANCIES_DRAFTS_ADVICE_DEFAULT";
        e.VacanciesArchivedAdviceDefault = "VACANCIES_ARCHIVED_ADVICE_DEFAULT";
        e.VacanciesTemplatesAdviceDefault =
          "VACANCIES_TEMPLATES_ADVICE_DEFAULT";
        e.VacanciesUnpremoderatedAdviceDefault =
          "VACANCIES_UNPREMODERATED_ADVICE_DEFAULT";
        e.VacanciesVrAdviceDefault = "VACANCIES_VR_ADVICE_DEFAULT";
        return e;
      })({});
      const s = Object.values(r);
    },
    268155: function (e, a, t) {
      t.d(a, {
        $w: () => u,
        BH: () => r,
      });
      ...
      const o = "UXFEEDBACK_TIMERS_KEY";
      const s = (e) => {
        i.Y.setItem(o, JSON.stringify(e));
      };
      const c = () => {
        const e = i.Y.getItem(o);
        if (e) {
          return JSON.parse(e);
        } else {
          return {};
      ...
      const m = (e, a, t) => {
        if (c()[a] && document.visibilityState === "visible") {
          r(e, t);
          d(a);
          n(a);
        }
      ...
      const u = (e) => {
        ...
        Object.entries(a).forEach(
          ([r, { eventName: o, attributes: s, scheduledTime: c }]) => {
            if (c <= t) {
              e({
                eventName: o,
                attributes: s,
...
]); //# sourceMappingURL=7877.66f6de8cbb36d175.js.map
//# debugId=b66fad82-7e25-4cd8-93ce-3a89991641d6
