  ...
  (function () {
    ...
    if (t) {
      ...
      e._sentryDebugIdIdentifier =
        "sentry-dbid-20dcd06a-0e15-4324-8029-fdf6d04de8b0";
    }
  })();
} catch (e) {}
(function () {
    ...
    ***************************************************************************** */
      ...
      var C = (function () {
        function e(e, t, n) {
          ...
          this.automaticDataCollectionEnabled_ =
            t.automaticDataCollectionEnabled || false;
        ...
        e.prototype._getService = function (e, t) {
          ...
          if (
            !r.isInitialized() &&
            r.getComponent()?.instantiationMode === "EXPLICIT"
          ) {
            r.initialize();
          }
      ...
      function O(e) {
        ...
        function a(s) {
          ...
          if (n.has(a)) {
            S.debug(
              "There were multiple attempts to register component " + a + ".",
            );
            if (s.type === "PUBLIC") {
              return r[a];
            } else {
          ...
          if (s.type === "PUBLIC") {
            ...
            e.prototype[a] = function () {
              ...
              return this._getService
                .bind(this, a)
                .apply(this, s.multipleInstances ? e : []);
            };
          }
      ...
      var L;
      var R = T;
      (P = R).INTERNAL.registerComponent(
        new s.wA(
          "platform-logger",
          function (e) {
            return new D(e);
    ...
    630909: function (e, t, n) {
      ...
      var a = (function () {
        ...
        e.prototype.getImmediate = function (e) {
          var t;
          var n = this.normalizeInstanceIdentifier(
            e == null ? undefined : e.identifier,
          );
          var r =
            (t = e == null ? undefined : e.optional) !== null &&
            t !== undefined &&
            t;
        ...
        e.prototype.initialize = function (e) {
          ...
          try {
            for (
              var c = (0, r.XA)(this.instancesDeferred.entries()), u = c.next();
              !u.done;
              u = c.next()
            ) {
    ...
    370120: function (e, t, n) {
      ...
      function T() {
        try {
          ...
          var t = (function (e) {
            n = e;
            var t = btoa(
              String.fromCharCode.apply(String, (0, s.ev)([], (0, s.CR)(n))),
            )
              .replace(/\+/g, "-")
              .replace(/\//g, "_");
            var n;
      ...
      function R() {
        if (!L && "BroadcastChannel" in self) {
          (L = new BroadcastChannel("[Firebase] FID Change")).onmessage =
            function (e) {
          ...
          return (0, s.Jh)(this, function (i) {
            switch (i.label) {
              ...
              case 1:
                ...
                return [
                  4,
                  (r = n.transaction(F, "readwrite")).objectStore(F).delete(t),
                ];
              case 2:
                i.sent();
                return [4, r.complete];
                        ...
                        return (0, s.Jh)(this, function (o) {
                          switch (o.label) {
                            ...
                            case 3:
                              if (
                                !b((r = o.sent())) ||
                                (r.customData.serverCode !== 401 &&
                                  r.customData.serverCode !== 404)
                              ) {
                                return [3, 5];
                              } else {
       ...
       * limitations under the License.
       */
      (j = i.Z).INTERNAL.registerComponent(
        new o.wA(
          "installations",
          function (e) {
            ...
            var n = (function (e) {
              ...
              try {
                for (
                  var r = (0, s.XA)(["projectId", "apiKey", "appId"]),
                    i = r.next();
                  !i.done;
                  i = r.next()
                ) {
      ...
      var ie;
      var oe;
      (G = {})["missing-app-config-values"] =
        'Missing App configuration value: "{$valueName}"';
      G["only-available-in-window"] =
        "This method is available in a Window context.";
      G["only-available-in-sw"] =
        "This method is available in a service worker context.";
      G["permission-default"] =
        "The notification permission was not granted and dismissed instead.";
      G["permission-blocked"] =
        "The notification permission was not granted and blocked instead.";
      G["unsupported-browser"] =
        "This browser doesn't support the API's required to use the firebase SDK.";
      G["failed-service-worker-registration"] =
        "We are unable to register the default service worker. {$browserErrorMessage}";
      G["token-subscribe-failed"] =
        "A problem occurred while subscribing the user to FCM: {$errorInfo}";
      G["token-subscribe-no-token"] =
        "FCM returned no token when subscribing the user to push.";
      G["token-unsubscribe-failed"] =
        "A problem occurred while unsubscribing the user from FCM: {$errorInfo}";
      G["token-update-failed"] =
        "A problem occurred while updating the user from FCM: {$errorInfo}";
      G["token-update-no-token"] =
        "FCM returned no token when updating the user to push.";
      G["use-sw-after-get-token"] =
        "The useServiceWorker() method may only be called once and must be called before calling getToken() to ensure your service worker is used.";
      G["invalid-sw-registration"] =
        "The input to useServiceWorker() must be a ServiceWorkerRegistration.";
      G["invalid-bg-handler"] =
        "The input to setBackgroundMessageHandler() must be a function.";
      G["invalid-vapid-key"] = "The public VAPID key must be a string.";
      G["use-vapid-key-after-get-token"] =
      ...
      function pe(e) {
        ...
        return btoa(
          String.fromCharCode.apply(String, (0, s.ev)([], (0, s.CR)(t))),
        )
          .replace(/=/g, "")
          .replace(/\+/g, "-")
          .replace(/\//g, "_");
                        ...
                        switch (s.label) {
                          case 0:
                            if (t.oldVersion < 2) {
                              ...
                              return [
                                4,
                                (n = t.transaction.objectStore(ge))
                                  .index("fcmSenderId")
                                  .get(e),
                              ];
                            } else {
            ...
            return (0, s.Jh)(this, function (r) {
              switch (r.label) {
                ...
                case 1:
                  n = r.sent();
                  this.vapidKey =
                    (n == null ? undefined : n.subscriptionOptions)?.vapidKey ??
                    ce;
                  r.label = 2;
                case 2:
                  return [
              ...
              switch (i.label) {
                case 0:
                  if (e.newSubscription) {
                    ...
                    return [
                      4,
                      Me(this.firebaseDependencies, self.registration),
                    ];
                  }
                case 1:
                case 5:
                ...
                case 4:
                  ...
                  return [
                    ...
                    Re(
                      this.firebaseDependencies,
                      self.registration,
                      (r == null ? undefined : r.subscriptionOptions)
                        ?.vapidKey ?? ce,
                    ),
                  ];
              }
                ...
                case 0:
                  if ((r = e.notification?.data?.[le])) {
                    if (e.action) {
                      ...
                      i = (function (e) {
                        var i =
                          e.fcmOptions?.link ?? e.notification?.click_action;
                        if (i) {
                          return i;
                        }
                        if (Je(e.data)) {
            ...
            return (0, s.Jh)(this, function (t) {
              switch (t.label) {
                ...
                case 2:
                  ...
                  return [
                    4,
                    this.updateVapidKey(e == null ? undefined : e.vapidKey),
                  ];
                case 3:
                  t.sent();
                  return [
                    4,
                    this.updateSwReg(
                      e == null ? undefined : e.serviceWorkerRegistration,
                    ),
                  ];
                case 4:
                  t.sent();
            ...
            return (0, s.Jh)(this, function (e) {
              switch (e.label) {
                ...
                case 2:
                  return [
                    2,
                    Me(this.firebaseDependencies, this.swRegistration),
                  ];
              }
            });
          });
            ...
            return (0, s.Jh)(this, function (t) {
              switch (t.label) {
                ...
                case 1:
                  ...
                  throw e === "denied"
                    ? ae.create("permission-blocked")
                    : ae.create("permission-default");
              }
            });
          });
        };
    ...
    244589: function (e, t, n) {
      ...
      function a() {
        try {
          return (
            Object.prototype.toString.call(n.g.process) === "[object process]"
          );
        } catch (e) {
          return false;
        }
